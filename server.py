...
class SpiceDatabase:
    ...
    def generate_spices(self):
        # 47 специй с полной информацией
        spices_data = [
            {'id': 1, 'name': 'Чёрный перец горошком', 'price': 350, 'supplier': 'ООО "Специи Мира"', 'stock': 100, 'rating': 5},
            {'id': 2, 'name': 'Корица цейлонская', 'price': 580, 'supplier': 'ИП "Пряный Двор"', 'stock': 45, 'rating': 4},
            {'id': 3, 'name': 'Куркума молотая', 'price': 220, 'supplier': 'ООО "Специи Мира"', 'stock': 150, 'rating': 5},
            {'id': 4, 'name': 'Паприка сладкая', 'price': 180, 'supplier': 'ООО "АгроСпеции"', 'stock': 200, 'rating': 4},
            {'id': 5, 'name': 'Имбирь молотый', 'price': 320, 'supplier': 'ИП "Пряный Двор"', 'stock': 80, 'rating': 4},
            {'id': 6, 'name': 'Кардамон зелёный', 'price': 1250, 'supplier': 'ООО "Восток-Специи"', 'stock': 25, 'rating': 5},
            {'id': 7, 'name': 'Гвоздика', 'price': 450, 'supplier': 'ООО "Специи Мира"', 'stock': 60, 'rating': 3},
            {'id': 8, 'name': 'Мускатный орех', 'price': 680, 'supplier': 'ИП "Пряный Двор"', 'stock': 35, 'rating': 4},
            {'id': 9, 'name': 'Кунжут белый', 'price': 150, 'supplier': 'ООО "АгроСпеции"', 'stock': 300, 'rating': 3},
            {'id': 10, 'name': 'Зира (кумин)', 'price': 280, 'supplier': 'ООО "Восток-Специи"', 'stock': 90, 'rating': 4},
            {'id': 11, 'name': 'Кориандр молотый', 'price': 190, 'supplier': 'ООО "Специи Мира"', 'stock': 120, 'rating': 3},
            {'id': 12, 'name': 'Шафран настоящий', 'price': 3500, 'supplier': 'ИП "Пряный Двор"', 'stock': 5, 'rating': 5},
            {'id': 13, 'name': 'Бадьян', 'price': 520, 'supplier': 'ООО "Восток-Специи"', 'stock': 40, 'rating': 4},
            {'id': 14, 'name': 'Асафетида', 'price': 890, 'supplier': 'ООО "Специи Мира"', 'stock': 20, 'rating': 3},
            {'id': 15, 'name': 'Фенхель', 'price': 240, 'supplier': 'ИП "Пряный Двор"', 'stock': 110, 'rating': 3},
            {'id': 16, 'name': 'Тмин', 'price': 210, 'supplier': 'ООО "АгроСпеции"', 'stock': 95, 'rating': 4},
            {'id': 17, 'name': 'Горчица белая', 'price': 120, 'supplier': 'ООО "Специи Мира"', 'stock': 250, 'rating': 3},
            {'id': 18, 'name': 'Укроп', 'price': 160, 'supplier': 'ИП "Пряный Двор"', 'stock': 180, 'rating': 4},
            {'id': 19, 'name': 'Петрушка', 'price': 140, 'supplier': 'ООО "АгроСпеции"', 'stock': 200, 'rating': 4},
            {'id': 20, 'name': 'Базилик', 'price': 170, 'supplier': 'ООО "Специи Мира"', 'stock': 160, 'rating': 4},
            {'id': 21, 'name': 'Орегано', 'price': 230, 'supplier': 'ИП "Пряный Двор"', 'stock': 85, 'rating': 3},
            {'id': 22, 'name': 'Розмарин', 'price': 290, 'supplier': 'ООО "Восток-Специи"', 'stock': 70, 'rating': 4},
            {'id': 23, 'name': 'Тимьян', 'price': 260, 'supplier': 'ООО "Специи Мира"', 'stock': 75, 'rating': 3},
            {'id': 24, 'name': 'Майоран', 'price': 310, 'supplier': 'ИП "Пряный Двор"', 'stock': 55, 'rating': 3},
            {'id': 25, 'name': 'Ваниль', 'price': 2800, 'supplier': 'ООО "Восток-Специи"', 'stock': 8, 'rating': 5},
            {'id': 26, 'name': 'Перец розовый', 'price': 720, 'supplier': 'ООО "Специи Мира"', 'stock': 30, 'rating': 4},
            {'id': 27, 'name': 'Перец душистый', 'price': 430, 'supplier': 'ИП "Пряный Двор"', 'stock': 65, 'rating': 4},
            {'id': 28, 'name': 'Хмели-сунели', 'price': 250, 'supplier': 'ООО "АгроСпеции"', 'stock': 130, 'rating': 4},
            {'id': 29, 'name': 'Аджика', 'price': 200, 'supplier': 'ООО "Специи Мира"', 'stock': 140, 'rating': 4},
            {'id': 30, 'name': 'Карри', 'price': 270, 'supplier': 'ИП "Пряный Двор"', 'stock': 120, 'rating': 5},
            {'id': 31, 'name': 'Пажитник', 'price': 340, 'supplier': 'ООО "АгроСпеции"', 'stock': 50, 'rating': 3},
            {'id': 32, 'name': 'Чили хлопья', 'price': 310, 'supplier': 'ООО "Специи Мира"', 'stock': 95, 'rating': 4},
            {'id': 33, 'name': 'Суммах', 'price': 380, 'supplier': 'ИП "Пряный Двор"', 'stock': 45, 'rating': 3},
            {'id': 34, 'name': 'Чернушка', 'price': 290, 'supplier': 'ООО "АгроСпеции"', 'stock': 60, 'rating': 3},
            {'id': 35, 'name': 'Анис звёздчатый', 'price': 480, 'supplier': 'ООО "Восток-Специи"', 'stock': 35, 'rating': 4},
            {'id': 36, 'name': 'Барбарис сушёный', 'price': 420, 'supplier': 'ИП "Пряный Двор"', 'stock': 40, 'rating': 3},
            {'id': 37, 'name': 'Калган (корень)', 'price': 560, 'supplier': 'ООО "Специи Мира"', 'stock': 25, 'rating': 3},
            {'id': 38, 'name': 'Можжевельник', 'price': 350, 'supplier': 'ООО "АгроСпеции"', 'stock': 30, 'rating': 3},
            {'id': 39, 'name': 'Мелисса сушёная', 'price': 220, 'supplier': 'ИП "Пряный Двор"', 'stock': 70, 'rating': 3},
            {'id': 40, 'name': 'Мята перечная', 'price': 190, 'supplier': 'ООО "Специи Мира"', 'stock': 110, 'rating': 4},
            {'id': 41, 'name': 'Шалфей', 'price': 280, 'supplier': 'ООО "Восток-Специи"', 'stock': 55, 'rating': 3},
            {'id': 42, 'name': 'Эстрагон', 'price': 260, 'supplier': 'ИП "Пряный Двор"', 'stock': 65, 'rating': 3},
            {'id': 43, 'name': 'Кинза сушёная', 'price': 200, 'supplier': 'ООО "АгроСпеции"', 'stock': 90, 'rating': 4},
            {'id': 44, 'name': 'Лавровый лист', 'price': 90, 'supplier': 'ООО "Специи Мира"', 'stock': 250, 'rating': 5},
            {'id': 45, 'name': 'Майоран садовый', 'price': 300, 'supplier': 'ИП "Пряный Двор"', 'stock': 50, 'rating': 3},
            {'id': 46, 'name': 'Чабер садовый', 'price': 320, 'supplier': 'ООО "Восток-Специи"', 'stock': 45, 'rating': 3},
            {'id': 47, 'name': 'Кресс-салат', 'price': 180, 'supplier': 'ООО "АгроСпеции"', 'stock': 80, 'rating': 3}
        ]
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .star { font-size: 12px; }
            .price-kg { font-size: 14px; }
            .price-100g { font-size: 10px; }
        }
    </style>
</head>
<body>
                    ...
                    <tr>
                        ...
                        <td style="white-space: nowrap;">
                            <div class="price-container">
                                <span class="price-kg">{{ s.price }} ₽ / кг</span>
                                <span class="price-100g">{{ "%.2f"|format(s.price / 10) }} ₽ / 100 г</span>
                            </div>
                        </td>
                        <td style="white-space: nowrap;">{{ s.stock }} кг</td>
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .price-100g { font-size: 18px; color: #888; margin-top: 5px; }
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="price">💰 Текущая цена: {{ spice.price }} ₽ / кг</div>
